...
static constexpr bool RequireTPCRefit{true};         // (d=false) require TPC refit
static constexpr bool RequireTPCStandalone{true};    // (d=false) require TPC standalone tracks
static constexpr int Min_NClusterTPC{35};            // (d=-1)(a=50)
static constexpr double Max_Chi2PerClusterTPC{10.};  // (d=1E10)(a=4)
static constexpr double Max_C11{1E3};                // (d=1E10)
static constexpr double Max_C22{1E3};                // (d=1E10)
static constexpr double Max_C33{1E3};                // (d=1E10)
static constexpr double Max_C44{1E3};                // (d=1E10)
static constexpr double Max_C55{1E3};                // (d=1E10)
...
static constexpr double Min_DCAxy_wrtPV{0.};         // (d=0.)
static constexpr double Max_DCAxy_wrtPV{1E10};       // (d=1E10)(a=2.4)
static constexpr double Min_DCAz_wrtPV{0.};          // (d=0.)
static constexpr double Max_DCAz_wrtPV{1E10};        // (d=1E10)(a=3.2)
// static constexpr bool DoDCACut_AsCircle{false};                            // (d=false) we don't use it as a circle
...
static constexpr bool RequireNSigmaToVertex{false};  // (d=true)
static constexpr double Max_NSigmaToVertex{2.};      // (d=1E10)

static constexpr double Max_Chi2TPCConstrainedVsGlobal{1E10};          // (d=1E10)(t<1E9)
...
static constexpr double Min_LengthActiveVolumeTPC{0.};  // (d=120., but never assigned)(t>1.)
...
static constexpr double GeoNcrNclLength{-1.};    // (b=130.)(t>0) cut on the geometical length condition Ngeom(cm)>cutGeoNcrNclLength default=130
